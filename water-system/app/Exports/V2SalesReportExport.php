...
class V2SalesReportExport
{
    ...
    public function build(): Spreadsheet
    {
        ...
        $summarySheet->setCellValue('A1', 'Taala Water System - V2 Sales Data Report');
        ...
        $summarySheet->getColumnDimension('C')->setWidth(4);
        $summarySheet->getColumnDimension('D')->setWidth(4);
