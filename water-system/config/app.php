...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Taala Crystal'),
    ...
    |--------------------------------------------------------------------------
    |
    | This value is used to determine the environment your application is
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This key is utilized by Laravel's encryption services and should be a
    | random, 32 character string. This should be kept secure and private.
    |
    */
